...
function draw()
{
    ...
    if(stats != "")
    {
        for (i = 0; i < objects.length; i++)
        {
            ...
            text(objects[i].label + " " + porcentagem + "%", objects[i].x + 100, objects[i].y + 60);
            noFill();
            stroke('red');
            rect(objects[i].x + 100, objects[i].y + 60, objects[i].width + 100, objects[i].height + 100);
        }
    }
}
